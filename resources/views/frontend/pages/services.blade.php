...
<main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('/frontend/assets/img/breadcrumbs-bg.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center aos-init aos-animate" data-aos="fade">
        ...
        <h2>@lang('main-page.services')</h2>
        <ol>
          <li><a href="/">@lang('main-page.home')</a></li>
          <li>@lang('main-page.services')</li>
        </ol>
    ...
    <section id="alt-services-2" class="alt-services section-bg">
      <div class="container aos-init" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-6 img-bg aos-init" style="background-image: url(/frontend/assets/img/alt-services-2.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
        </div>
    ...
    <section id="alt-services" class="alt-services">
      <div class="container aos-init" data-aos="fade-up">
        ...
        <div class="row justify-content-around gy-4">
          <div class="col-lg-6 img-bg aos-init" style="background-image: url(/frontend/assets/img/alt-services.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
    ...
    <section id="testimonials" class="testimonials section-bg">
      <div class="container aos-init" data-aos="fade-up">
        ...
        <div class="slides-2 swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
          <div class="swiper-wrapper" id="swiper-wrapper-e775dc43618cebf8" aria-live="off" style="transform: translate3d(-1974px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 5" style="width: 638px; margin-right: 20px;">
            ...
            </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="5 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
            ...
            <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="0" role="group" aria-label="1 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
            ...
            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="1" role="group" aria-label="2 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
            ...
            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="2" role="group" aria-label="3 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
            ...
            <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="/frontend/assets/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                  <h3>Matt Brandon</h3>
            ...
            <div class="swiper-slide" data-swiper-slide-index="4" role="group" aria-label="5 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="/frontend/assets/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                  <h3>John Larson</h3>
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="0" role="group" aria-label="1 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="/frontend/assets/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                  <h3>Saul Goodman</h3>
            ...
            </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="1" role="group" aria-label="2 / 5" style="width: 638px; margin-right: 20px;">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="/frontend/assets/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                  <h3>Sara Wilsson</h3>
