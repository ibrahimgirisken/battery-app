...
<main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('/frontend/assets/img/breadcrumbs-bg.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center aos-init aos-animate" data-aos="fade">
        ...
        <h2>@lang('main-page.projects')</h2>
        <ol>
          <li><a href="/">@lang('main-page.home')</a></li>
          <li>@lang('main-page.projects')</li>
        </ol>
    ...
    <section id="projects" class="projects">
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
          ...
          <div class="row gy-4 portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" style="position: relative; height: 1344px;">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-construction" style="position: absolute; left: 440px; top: 0px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-repairs" style="position: absolute; left: 880px; top: 0px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-design" style="position: absolute; left: 0px; top: 336px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling" style="position: absolute; left: 440px; top: 336px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-construction" style="position: absolute; left: 880px; top: 336px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-repairs" style="position: absolute; left: 0px; top: 672px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-design" style="position: absolute; left: 440px; top: 672px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling" style="position: absolute; left: 880px; top: 672px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-construction" style="position: absolute; left: 0px; top: 1008px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-repairs" style="position: absolute; left: 440px; top: 1008px;">
              <div class="portfolio-content h-100">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-design" style="position: absolute; left: 880px; top: 1008px;">
              <div class="portfolio-content h-100">
